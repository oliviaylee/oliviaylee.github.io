...
<div style="display: flex; align-items: flex-start;">
  <div style="flex: 1; padding-right: 20px;">
    ...
    <i>In review. Robotics Science and Systems (RSS), 2024: [Task Specification](https://sites.google.com/view/rss-taskspec){:target="_blank"} & [Lifelong Robot Learning](https://sites.google.com/view/lifelong-robot-learning){:target="_blank"}</i> <br>
...
<div style="display: flex; align-items: flex-start;">
  <div style="flex: 1; padding-right: 20px;">
    ...
    <i>Robotics Science and Systems (RSS), 2022 [\[recording\]](https://youtu.be/qI0zvRp-UnE?t=4034)</i> <br>
